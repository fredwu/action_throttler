...
<tt>ActionThrottler::Actions.can_be_run?</tt> returns <tt>true</tt> or <tt>false</tt> without performing the action, and it also has a negative alias, <tt>ActionThrottler::Actions.cannot_be_run?</tt>.
